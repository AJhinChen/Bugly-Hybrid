...
@interface AJKeyValueStore()

@end

@implementation AJKeyValueStore
...
- (void)createTableWithName:(NSString *)tableName {
    if ([AJKeyValueStore checkTableName:tableName] == NO) {
        return;
    }
...
- (id)getObjectById:(NSString *)objectId fromTable:(NSString *)tableName {
    AJKeyValueItem * item = [self getAJKeyValueItemById:objectId fromTable:tableName];
    if (item) {
