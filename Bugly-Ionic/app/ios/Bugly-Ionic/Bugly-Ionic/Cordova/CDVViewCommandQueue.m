...
@implementation CDVViewCommandQueue
...
{
    __weak CDVViewCommandQueue* weakSelf = self;
    NSString* js = @"cordova.require('cordova/exec').nativeFetchMessages()";
    
    [_view.webViewEngine evaluateJavaScript:js
...
- (BOOL)execute:(CDVInvokedUrlCommand*)command
{
    ...
    CDVPlugin* obj = [_view.commandDelegate getCommandInstance:command.className];
