...
//    NSLog(@"currentDevice Information: %@", [[UIDevice currentDevice] uuid]);
...
- (void)customizeInterfaceWithTabBarController:(CYLTabBarController *)tabBarController {
    ...
    @try {
        ...
        //添加提示动画，引导用户点击
        [self addScaleAnimationOnView:tabBarController.viewControllers[0].cyl_tabButton.cyl_tabImageView repeatCount:3];
...
//        }
    ...
    if ([control cyl_isPlusButton]) {
        ...
        UINavigationController *nav = [[UINavigationController alloc] initWithRootViewController:[PlusViewController new]];
